    ...
    return (
        <div className={CLASS}>
            <div className={'flex justify-between items-center'}>
                ...
                <Button label={'Create team'} size={'s'} type={'button'} classname={'w-[230px]'} onClick={() => onNavigate(routes.teams.create)}/>
            </div>
            ...
            <div className={'flex flex-col gap-4'}>
                ...
                <div className={'flex flex-wrap gap-4'}>
                    {teams.map((team) =>
                        <div key={team.id} className={`${CLASS}__card`} onClick={() => onNavigate(`/teams/${team.id}`)}>
